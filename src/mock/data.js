...
export const aboutData = {
  img: 'profile.jpg',
  paragraphOne: "Hi! Welcome to my page. I'm Ahmed Ali, a fullstack software developer. My web applications are built with meticulous detail to perform exceptionally across all hardware.",
  paragraphTwo: 'MERN stack development.',
  paragraphThree: 'Experienced in: HTML/CSS & JS, Node, Express, MySQL, Mongo, React, and more. ',
  resume: '',
};
